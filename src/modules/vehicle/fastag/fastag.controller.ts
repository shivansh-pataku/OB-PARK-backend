...
export class FastagController {
  ...
  @ApiOperation({
    ...
    description:
      'Validates and retrieves the FasTag bank, tag ID, and status associated with the vehicle registration certificate (RC) number.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Validates and retrieves the FasTag bank, tag ID, status, and transaction history associated with the vehicle registration certificate (RC) number.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves current available balance, recharge limit, tag status, and vehicle class associated with the vehicle registration certificate (RC) number and FASTag provider.',
  })
  @ApiResponse({
    status: 200,
