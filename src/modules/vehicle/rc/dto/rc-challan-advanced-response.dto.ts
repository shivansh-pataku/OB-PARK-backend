...
export class ChallanAdvancedDto {
    ...
    @ApiProperty({ example: 'Over speeding - Exceeding speed limit by 25 kmph in 60 kmph zone' })
    offenseDetails: string;

    @ApiProperty({ example: 'Western Express Highway, Andheri East, Mumbai', nullable: true })
    place: string | null;
